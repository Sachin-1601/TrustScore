  ...
  return (
    <div className="space-y-3.5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3.5">
        {/* Followers */}
        <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-xs hover:border-blue-300 transition-all">
        ...
        {/* Engagement Rate */}
        <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-xs hover:border-emerald-300 transition-all">
          <div className="flex items-center justify-between text-slate-500">
        ...
        {/* Avg Likes */}
        <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-xs hover:border-rose-300 transition-all">
          <div className="flex items-center justify-between text-slate-500">
        ...
        {/* Avg Comments */}
        <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-xs hover:border-amber-300 transition-all">
          <div className="flex items-center justify-between text-slate-500">
        ...
        {/* Total Posts */}
        <div className="p-4 bg-white border border-slate-200 rounded-2xl space-y-2 shadow-xs hover:border-purple-300 transition-all">
          <div className="flex items-center justify-between text-slate-500">
      ...
      {!hasHistory && (
        <div className="p-2.5 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center gap-2 text-[11px] text-slate-500">
