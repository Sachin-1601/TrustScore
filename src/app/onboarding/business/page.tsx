      ...
      <main className="max-w-3xl mx-auto w-full px-4 sm:px-6 py-8 sm:py-12 flex-1 flex flex-col justify-center">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-3 text-xs font-medium text-slate-400">
            <span className={step >= 1 ? "text-blue-400 font-semibold" : ""}>1. Business Profile</span>
            <span className={step >= 2 ? "text-blue-400 font-semibold" : ""}>2. Goals</span>
            <span className={step >= 3 ? "text-blue-400 font-semibold" : ""}>3. Preferences</span>
            <span className={step >= 4 ? "text-blue-400 font-semibold" : ""}>4. Verification</span>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur-xl">
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-tight text-white">Create Your Brand Workspace</h2>
                    ...
                    {LOGO_OPTIONS.map((url, idx) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl overflow-hidden border-2 transition-all ${
                          logo === url ? "border-blue-500 scale-105" : "border-slate-700 opacity-60 hover:opacity-100"
                        }`}
                      >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                  >
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-tight text-white">What Do You Want to Achieve?</h2>
                <p className="text-sm text-slate-400 mt-1">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4 rounded-xl border text-left transition-all flex items-start justify-between gap-4 ${
                        isChecked
                          ? "bg-blue-600/15 border-blue-500 text-white shadow-md shadow-blue-500/5"
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-tight text-white">Target Creator Preferences</h2>
                <p className="text-sm text-slate-400 mt-1">
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-tight text-white">TrustScore Business Verification</h2>
                <p className="text-sm text-slate-400 mt-1">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 flex items-start gap-3.5">
                  <div className="p-2 rounded-lg bg-emerald-500/10 text-emerald-400 shrink-0">
                    <ShieldCheck className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-white">Verified Brand Status</h3>
                ...
                <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-white">Direct Marketplace Access</h3>
                    <p className="text-xs text-slate-400 mt-0.5">
          ...
          {step === 5 && (
            <div className="space-y-6 text-center py-4">
              ...
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Your Business Workspace Is Ready</h2>
              ...
              <div className="max-w-md mx-auto p-4 rounded-xl bg-slate-950/80 border border-slate-800 text-left flex items-center gap-4">
                <img src={logo} alt={companyName} className="w-14 h-14 rounded-xl object-cover border border-slate-700" />
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold text-white truncate">{companyName}</p>
                  <p className="text-xs text-blue-400 font-medium">{category}</p>
